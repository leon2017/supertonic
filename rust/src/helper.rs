...
pub const AVAILABLE_LANGS: &[&str] = &["en", "ko", "ja", "zh", "ar", "bg", "cs", "da", "de", "el", "es", "et", "fi", "fr", "hi", "hr", "hu", "id", "it", "lt", "lv", "nl", "pl", "pt", "ro", "ru", "sk", "sl", "sv", "tr", "uk", "vi", "na"];
...
impl TextToSpeech {
    ...
    pub fn call(
        ...
        let max_len = if lang == "ko" || lang == "ja" || lang == "zh" { 120 } else { 300 };
