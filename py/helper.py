...
AVAILABLE_LANGS = ["en", "ko", "ja", "zh", "ar", "bg", "cs", "da", "de", "el", "es", "et", "fi", "fr", "hi", "hr", "hu", "id", "it", "lt", "lv", "nl", "pl", "pt", "ro", "ru", "sk", "sl", "sv", "tr", "uk", "vi", "na"]
...
class TextToSpeech:
    ...
    def __call__(
        ...
        max_len = 120 if lang in ("ko", "ja", "zh") else 300
